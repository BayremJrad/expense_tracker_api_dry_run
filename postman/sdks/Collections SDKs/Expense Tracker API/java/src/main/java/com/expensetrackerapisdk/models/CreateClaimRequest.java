...
public class CreateClaimRequest {
  ...
  private JsonNullable<List<String>> expenseIds;
  ...
  public List<String> getExpenseIds() {
    return expenseIds.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class CreateClaimRequestBuilder {

    private JsonNullable<String> title = JsonNullable.undefined();

    @JsonProperty("title")
    public CreateClaimRequestBuilder title(String value) {
      this.title = JsonNullable.of(value);
      return this;
    }

    private JsonNullable<List<String>> expenseIds = JsonNullable.undefined();

    @JsonProperty("expenseIds")
    public CreateClaimRequestBuilder expenseIds(List<String> value) {
      this.expenseIds = JsonNullable.of(value);
      return this;
    }

    @JsonAnySetter
    public CreateClaimRequestBuilder additionalProperties(String key, Object value) {
