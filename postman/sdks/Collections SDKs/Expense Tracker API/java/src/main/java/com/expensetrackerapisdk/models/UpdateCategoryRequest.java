...
public class UpdateCategoryRequest {
  ...
  private JsonNullable<Long> receiptThreshold;
  ...
  @JsonIgnore
  public Long getReceiptThreshold() {
  ...
  public static class UpdateCategoryRequestBuilder {
    ...
    private JsonNullable<Long> receiptThreshold = JsonNullable.undefined();

    @JsonProperty("receiptThreshold")
    public UpdateCategoryRequestBuilder receiptThreshold(Long value) {
