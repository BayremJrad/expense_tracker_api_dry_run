...
public class RejectClaimRequest {
  ...
  public static class RejectClaimRequestBuilder {

    private JsonNullable<String> reason = JsonNullable.undefined();

    @JsonProperty("reason")
    public RejectClaimRequestBuilder reason(String value) {
      this.reason = JsonNullable.of(value);
      return this;
    }

    @JsonAnySetter
    public RejectClaimRequestBuilder additionalProperties(String key, Object value) {
