...
@EqualsAndHashCode
@Jacksonized
public class ListCategoriesParameters {

  /**
   * Set to true (Finance only) to include retired categories in the response.
   */
  @JsonProperty("includeRetired")
  private JsonNullable<String> includeRetired;
  ...
  public String getIncludeRetired() {
    return includeRetired.orElse(null);
  }

  // Overwrite lombok builder methods
  public static class ListCategoriesParametersBuilder {

    private JsonNullable<String> includeRetired = JsonNullable.undefined();

    @JsonProperty("includeRetired")
    public ListCategoriesParametersBuilder includeRetired(String value) {
      if (value == null) {
        throw new IllegalStateException("includeRetired cannot be null");
      }
      this.includeRetired = JsonNullable.of(value);
      return this;
    }

    @JsonAnySetter
    public ListCategoriesParametersBuilder additionalProperties(String key, Object value) {
