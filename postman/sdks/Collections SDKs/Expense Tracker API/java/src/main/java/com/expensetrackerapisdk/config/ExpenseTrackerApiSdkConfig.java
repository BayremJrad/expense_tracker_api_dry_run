package com.expensetrackerapisdk.config;

import com.expensetrackerapisdk.http.Environment;
import com.expensetrackerapisdk.logging.LogConfig;
...
@Builder
@Data
public class ExpenseTrackerApiSdkConfig {

  @NonNull
  @Builder.Default
  private String userAgent = "postman-codegen/2.8.0 expensetrackerapisdk/1.0.0 (java)";
